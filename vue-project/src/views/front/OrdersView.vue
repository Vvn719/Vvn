<template>
  <div class="OrderContain">
    <h1 style="margin-left: 20px">My Orders</h1>
    <n-table>
      <thead>
        <tr>
          <th>訂購日期</th>
        ...
        <tr v-for="order in orders" :key="order._id">
          ...
          <td style="width: 35%">
            <n-collapse arrow-placement="right">
              <n-collapse-item title="Order List" style="text-align: left">
                <div v-for="product in order.products" :key="product._id">
                  <n-tbody single-column :single-line="false">
                    <tr>
          ...
          <td>
            <n-button text>
              <n-icon size="22"><infoIcon /></n-icon>
            </n-button>
          </td>
        </tr>
      </tbody>
...
import { CheckmarkSharp as checkIcon, CloseCircleOutline as closeIcon, DocumentTextOutline as infoIcon } from '@vicons/ionicons5'
